...
export const PROJECTS: Project[] = [
  {
    ...
    longSections: [
      ...
      {
        heading: "Une conception paysagère sur-mesure, entre ouverture et intimité",
        paragraphs: [
      ...
      {
        heading: "Éclairage et scénographie : Une expérience du jardin, de jour comme de nuit",
        paragraphs: [
  ...
  },
  {
    ...
    longSections: [
      ...
      {
        heading: "Optimisation des volumes : Une maison pensée autour de la verticalité",
        paragraphs: [
      ...
      {
        heading: "Apport de lumière naturelle : La lumière comme véritable matériau d'architecture",
        paragraphs: [
      ...
      {
        heading: "Sélection écoresponsable : Des matériaux sobres, nobles et durables",
        paragraphs: [
  ...
  },
  {
    ...
    longSections: [
      ...
      {
        heading: "Redéfinition des volumes : Une organisation plus fluide des espaces",
        paragraphs: [
      ...
      {
        heading: "Des matériaux naturels et nobles au service de l'architecture d'intérieur",
        paragraphs: [
      ...
      {
        heading: "Optimisation de la lumière naturelle : Une rénovation pensée autour de la clarté",
        paragraphs: [
  ...
  },
  {
    ...
    longSections: [
      {
        heading: "Réhabilitation de brasserie : Révéler la mémoire d'un lieu pour lui offrir une nouvelle vie",
        paragraphs: [
      ...
      {
        heading: "Design & Identity : Une architecture intérieure entre héritage et modernité",
        paragraphs: [
      ...
      {
        heading: "Ouverture In & Out : Un dialogue entre la brasserie et son environnement urbain",
        paragraphs: [
      ...
      {
        heading: "Optimisation des flux et des espaces : Une transformation pensée autour des usages",
        paragraphs: [
